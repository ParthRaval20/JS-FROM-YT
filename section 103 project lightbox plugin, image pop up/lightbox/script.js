...
function includePopupHTML(){
    ...
    let html = '<div id="vis-popup"><span id="close" onclick = "closePopUp()"><img id="npop" src="lightbox/images/error.png" alt=""></span><img id="leftarrow" src="lightbox/images/left-arrow.png" alt=""><img id="rightarrow" src="lightbox/images/arrow-right.png" alt=""><img id="" src="" alt=""><img id="mainPopImage" src="images/mac.jpeg" alt=""></div>';
